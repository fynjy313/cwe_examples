...
* [TODO!](#todo)
  ...
  * [10. CWE-91: XML Injection (aka Blind XPath Injection)](#10-cwe-91-xml-injection-aka-blind-xpath-injection)
    ...
    * [10.3. Примеры](#103-примеры)
      ...
      * [*Пример 2. Добавление пользователя в XML документ при помощи javax.xml.bind.Marshaller*](#пример-2-добавление-пользователя-в-xml-документ-при-помощи-javaxxmlbindmarshaller)
