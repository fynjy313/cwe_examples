...
public interface ProductRepository extends JpaRepository<Product, Integer> {
    ...
    @Query(value = "SELECT * FROM product_tbl t WHERE t.name LIKE %?1%", nativeQuery = true)
    ...
    */
    ...
    List<Product> findByName_JPQL(String name);
    ...
    List<Product> findByName_JPQL_param(@Param("id") String name);
